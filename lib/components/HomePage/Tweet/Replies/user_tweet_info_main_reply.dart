                  ...
                  children: [
                    ...
                    if (!isfollowed[2])
                      CustomButton(
                        ...
                        text: text,
                        onPressedCallback: () {
                          BlocProvider.of<EditProfileCubit>(context).emit(ProfilePageLoadingState());
                          ...
                          BlocProvider.of<EditProfileCubit>(context).emit(ProfilePageCompletedState());
                        ...
                        child: Wrap(
                          children: [
                            RichText(
                              ...
                              children: widget.replyto.asMap().entries.map((e) {
                                return TextSpan(
                                    text: '${'@' + e.value}',
                                    style: const TextStyle(
                                        fontWeight: FontWeight.w400,
